...
Các metric chỉ báo sức khỏe pipeline:
...
Mục tiêu của bạn nên là: phát hiện sự cố *bằng tự động hóa, không bằng con người*; có cơ chế giảm thiệt hại mạnh (backup, staged release) và đòn bẩy rollback (feature flag); và đào tạo team về incident response (playbook, runbook).
