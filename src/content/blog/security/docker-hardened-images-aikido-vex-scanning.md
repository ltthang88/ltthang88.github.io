...
Tích hợp lần này vá đúng cái gap đó. Mỗi DHI image đi kèm một **VEX attestation đã ký số** — hiểu nôm na là tờ "giấy chứng nhận" Docker dán lên image, ghi rõ CVE nào đã xử lý, CVE nào không ảnh hưởng. Aikido đọc tờ giấy này lúc triage và lọc bớt những CVE Docker đã "tha", kèm lý do rõ ràng.
...
- **Signed SBOMs** giúp Aikido có dữ liệu thành phần đầy đủ mà không cần cố dò filesystem distroless.
