...
`Kubernetes` · `CI/CD` · `Networking` · `Career` · `Security` · `Observability` · `Platform`
...
6. Nếu viết lại từ nguồn → dựng outline riêng, thêm trải nghiệm, ghi nguồn ở cuối; cần ảnh → ưu tiên tự vẽ SVG.
